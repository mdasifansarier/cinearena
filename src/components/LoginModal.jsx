...
const LoginModal = () => {
  ...
  const { login, resetDevice, isLoginOpen, closeLogin } = useAuth();
  ...
  const handleReset = async () => {
    ...
    await resetDevice(username, password);
    showToast('✅ Device ID has been reset!');
  };
      ...
      <div className="login-modal">
        ...
        <div className="login-footer">
          ...
          <div className="social-links">
            <a href="https://wa.me/+916287282692" target="_blank" rel="noopener noreferrer">
